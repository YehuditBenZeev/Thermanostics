...
class Palm:
    ...
    def draw_on_point(self):
        ...
        print("finger 1: top_1 = ", self.finger1.top_1[0], ",", self.finger1.top_1[1], "top_2 = ", self.finger1.top_2[0]
              , ",", self.finger1.top_2[1], "bottom_1 = ", self.finger1.bottom_1[0], ",", self.finger1.bottom_1[1],
              "bottom_2 = ", self.finger1.bottom_2[0], ",", self.finger1.bottom_2[1])
        ...
        cv2.circle(p, (self.finger2.bottom_1[0], self.finger2.bottom_1[1]), 4, (255, 0, 0), 2)
        ...
        print("finger 2: top_1 = ", self.finger2.top_1[0], ",", self.finger2.top_1[1], "top_2 = ", self.finger2.top_2[0]
              , ",", self.finger2.top_2[1], "bottom_1 = ", self.finger2.bottom_1[0], ",", self.finger2.bottom_1[1],
              "bottom_2 = ", self.finger2.bottom_2[0], ",", self.finger2.bottom_2[1])
        ...
        print("finger 4: top_1 = ", self.finger4.top_1[0], ",", self.finger4.top_1[1], "top_2 = ", self.finger4.top_2[0]
              , ",", self.finger4.top_2[1], "bottom_1 = ", self.finger4.bottom_1[0], ",", self.finger4.bottom_1[1],
              "bottom_2 = ", self.finger4.bottom_2[0], ",", self.finger4.bottom_2[1])
        ...
        print("finger 5: top_1 = ", self.finger5.top_1[0], ",", self.finger5.top_1[1], "top_2 = ", self.finger5.top_2[0]
              , ",", self.finger5.top_2[1], "bottom_1 = ", self.finger5.bottom_1[0], ",", self.finger5.bottom_1[1],
              ", bottom_2 = ", self.finger5.bottom_2[0], ",", self.finger5.bottom_2[1])
    ...
    def detect_bottom_point_finger_1(self, top_finger, bottom_finger):
        rows, columns = self.image.shape
        start_i = top_finger.top_1[1]
        end_i = bottom_finger.top_1[1] - self.finger_width
        start_j = bottom_finger.top_1[0]
        end_j = rows - 1
        border_point = []
        b_w_i = Ip.edge_detecting(self.image, 300, 10)
    ...
    def detect_bottom1_finger2(self):
        rows, columns = self.image.shape
        i_distance = abs(self.finger3.bottom_2[0] - self.finger3.bottom_1[0])
        i = self.finger2.bottom_2[0] + i_distance
        self.finger2.bottom_1[0] = i

        for j in range(self.finger1.bottom_2[1], rows - 1):
            # p = np.array(self.image)
            # cv2.circle(p, (i, j), 4, (255, 0, 0), 2)
            # Ip.show_pic(p, "show")

            if self.black_white_image[j][i] == 0 and self.black_white_image[j-1][i] != 0:
                self.finger2.bottom_1[1] = j
                break
        print("i, j: ", self.finger2.bottom_1[0], self.finger2.bottom_1[1])
    ...
    def detect_fingers(self):
        ...
        self.detect_bottom_point_finger_1(self.finger1, self.finger2)

        self.detect_bottom1_finger2()
