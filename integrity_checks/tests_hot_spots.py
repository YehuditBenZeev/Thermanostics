...
class TestsHotSpots:
    def __init__(self, expected_points, detected_points):
        self.expected_points = read_from_file(expected_points)  # alona
        self.detected_points = read_from_file(detected_points)  # algorithm  # hold [bool, (x, y)]
    ...
    def check_success(self):
        true_positive = 0  # The algorithm predicted a hot spot and there is
