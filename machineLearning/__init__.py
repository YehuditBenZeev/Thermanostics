...
class Machine:
    ...
    def array_predict(self,value_model):
        ...
        for word in self.array_image:
            ...
            if num_of_hotpoint[i] >value_model: #I predict that if there are more than value_model hot spots then the person is sick - positive
                i+=1
...
if __name__ == '__main__':
    array_image=["505 RF S.bmp","505 RF H.bmp","505 RF S.bmp"]
    s = Machine(array_image)
    s.array_labbel() # sick or healthy
    s.array_predict(10)
    s.conf_matrix()
